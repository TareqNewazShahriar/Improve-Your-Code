...
* If a new point is needed to be added after or before another point which is at the middle, number it like ‘10.0’ or ‘10.1’ etc. But existing point numbers must not be changed.
---------------------------------
